...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, BREAKER2_Pin|BREAKER1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BREAKER2_Pin BREAKER1_Pin */
  GPIO_InitStruct.Pin = BREAKER2_Pin|BREAKER1_Pin;
