...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PD2     ------> UART5_RX
    */
    GPIO_InitStruct.Pin = NONE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_UART5;
    HAL_GPIO_Init(NONE_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    */
    ...
    hdma_uart9_tx.Init.FIFOMode = DMA_FIFOMODE_ENABLE;
    hdma_uart9_tx.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_FULL;
    hdma_uart9_tx.Init.MemBurst = DMA_MBURST_SINGLE;
    hdma_uart9_tx.Init.PeriphBurst = DMA_PBURST_SINGLE;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(NONE_GPIO_Port, NONE_Pin);
